...
export const PROJECTS_SECTION = {
  ...
  projects: [
    ...
    {
      title: "MedicalApp - приложение для отслеживания показателей здоровья пациентов",
      description: "Приложение для отслеживания показателей здоровья пациентов, предлагающее анализ здоровья от ИИ на основе данных о пациенте, а также прикрепление к врачу. Разработано в рамках хакатона \"Код на крыше 2024\" и заняло 1 место. Также приложение было представлено на \"TulaHackDays 2024\"",
      imageUrl: "/images/MedicalApp/preview.png",
      students: [
        { name: "Калитов Александр", group: "2ИСП9-43" },
        { name: "Исаев Вячеслав", group: "2ИСП9-43" },
        { name: "Деменьтев Максим", group: "2ИСП9-43" },
      ],
      tags: ["TypeScript", "React", "TailwindCSS", "NestJS", "PostgreSQL", "Docker"]
    },
    {
